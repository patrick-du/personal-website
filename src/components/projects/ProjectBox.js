            ...
            <div className="row my-3" style={styles.row}>
                <div className="col-7">
                    <div className="pr-5">
                        ...
                        <a href="https://github.com/patrick-du/Personal-Website-v2" target="_blank"><button type="button" class="btn s-font pbButton">View on Github</button></a>
            ...
            <div className="row my-3" style={styles.row}>
                <div className="col-7">
                    <div className="pr-5">
                        ...
                        <p className="s-font" style={styles.body}>This is the 2nd version of my portfolio website. The original can be found <a href="https://patrickdu.herokuapp.com" target="_blank" className="hlink">here</a>.</p>
                        <a href="https://github.com/patrick-du/Personal-Website-v2" target="_blank"><button type="button" class="btn s-font pbButton">View on Github</button></a>
                    </div>
                </div>
            ...
            <div className="row my-3" style={styles.row}>
                <div className="col-7">
                    <div className="pr-5">
                        ...
                        <a href="https://github.com/patrick-du/FitBud" target="_blank"><button type="button" class="btn s-font pbButton">View on Github</button></a>
                    </div>
                </div>
