        ...
        <div className="container-fluid mx-auto px-0">
            ...
            <div className="projectContainer mx-auto px-0">
                <Fade big>
                    ...
                    <hr className="my-3"/>
                    <p className="general-font">This is the website you're on right now! I created this website to reinforce what I had learned after completing a React JS course. This includes state management, lifecycle methods, routing, understanding data flow, and thinking in components.</p>
                    <p className="general-font">This website was developed for personal and professional usage. It is the 2nd version of my portfolio and the original can be found <a href="https://patrickdu.herokuapp.com" target="_blank" className="hvr-underline-from-left purple">here</a>. View the full project on <a href="https://github.com/patrick-du/Personal-Website-v2" target="_blank" className="hvr-underline-from-left purple">Github</a>.</p>
                    <hr />
                </Fade>
