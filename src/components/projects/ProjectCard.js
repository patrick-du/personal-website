...
const ProjectCard = (props) => {
    const { link, imgPath, projName, projDesc, projWhat, projType } = props;
    return (
            ...
            <div className="projectCard hvr-box hvr-float">
                <div id="under768">
                    ...
                    <div className="projectCardText pt-3">
                        <div className="general-font" id="projName">{projName}
                            <span><i class="fas fa-arrow-right" id="projRightArrow"/></span>
                ...
                <div id="above768">
                    ...
                    <div id="projCol2" style={{ padding: '1rem' }}>
                        <div className="projectCardText general-font px-0">
                            ...
                            <p id="projDesc">{projDesc}<div id="projType">{projType}</div></p>
                        </div>
                    </div>
                </div>
            </div>
