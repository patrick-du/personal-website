    ...
    return (
        <div className="container-fluid projectContainer mx-auto px-0">
            <Fade big>
                ...
                <ProjectCard link="/work/oculyshealthinformatics" imgPath="fgfB-opt.png" projDesc="Oculys Health Informatics" projWhat="Currently in construction :)" projName="Software Developer" projType="September - December 2019" />
                ...
                <ProjectCard link="/work/serenity" imgPath="huddleB-opt.png" projDesc="React, Node (Express), MongoDB" projWhat="Currently in construction :)" projName="Serenity" projType="Side Project" />
