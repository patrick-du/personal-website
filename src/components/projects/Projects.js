    ...
    return (
        <div className="container-fluid projectContainer mx-auto px-0">
            ...
            <Fade big>
                ...
                <ProjectCard link="/work/huddle" backgroundColor="#ff6b81" imgPath="huddleB-opt.png" projDesc="React Native, Java (Spring), Maven, MySQL" projWhat="A modern sports betting mobile app to connect fans and support local venues..." projName="Huddle" projType="Side Project" />
                <ProjectCard link="/work/userauth" backgroundColor="#ff7675" imgPath="userAuth.png" projDesc="Node JS, Express JS, MongoDB" projWhat="A user authentication boilerplate for future projects..." projName="User Authentication" projType="Side Project" />
                ...
                <ProjectCard link="/work/personalwebsite" backgroundColor="#7bed9f" imgPath="websiteB-opt.png" projDesc="React JS" projWhat="A portfolio to illustrate who I am and showcase my projects and past work..." projName="Personal Website" projType="Side Project" />
