...
const Projects = () => {
    return (
        <div className="container-fluid container-padding">
            ...
            <ProjectCard link="/projects/fgfbrands" backgroundColor="#fd79a8" imgPath="huddle.png" projDesc="FGF Brands" projWhat="My first real-world programming experience" projName="Front-End Developer" projType="January 2019 - April 2019" />
