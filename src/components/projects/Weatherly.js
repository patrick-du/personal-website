        ...
        <div className="container-fluid px-0">
            ...
            <div className="projectContainer mx-auto px-0">
                ...
                <ul>
                    ...
                    <p className="general-font">Despite facing an abundance of issues whether it be with plain JavaScript or registering Service Workers, I am glad that I stuck through with the project as it was a rewarding experience.</p>
                    <p className="general-font">This app was developed with HTML, CSS, and JavaScript. View the full project on <a href="https://github.com/patrick-du/patrick-du.github.io" target="_blank" className="hvr-underline-from-left purple">Github</a> or <a href="https://patrickdu-weatherly.herokuapp.com" target="_blank" className="hvr-underline-from-left purple">try it yourself</a>.</p>
                    <hr />
                </Fade>
