        ...
        <div className="container-fluid px-0">
            ...
            <div className="projectContainer mx-auto px-0">
                <Fade big>
                    ...
                    <p className="general-font">User Authentication provides a secure way for users to register and login to their account without third-party strategies. I utilized Passport JS, an authentication middleware, and adopted their local username and password authentication strategy. I stored the accounts into MongoDB, a non-relational database, and retrieved data through the application's endpoints.</p>
                        
                    <BorderPic imgPath="userAuth6.png" picDesc="Account Screen, Update Account Details" />

                    <p className="general-font">This app was developed with Node (Express) and MongoDB. View the full project on <a href="https://github.com/patrick-du/auth-bp" target="_blank" className="hvr-underline-from-left purple">Github</a> or <a href="https://patrickdu-userauth-boilerplate.herokuapp.com" target="_blank" className="hvr-underline-from-left purple">try it yourself</a>.</p>
                <hr/>
                </Fade>
