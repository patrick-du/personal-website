        ...
        <div className="container-fluid  mx-auto px-0">
            ...
            <div className="projectContainer mx-auto px-0">
                <Fade big>
                    ...
                    <p className="general-font">We incorporated the friend finding feature for all members of the gym with the main purpose being to create a friendly and safe environment for all gym-goers. This allows for members to make a new friend and feel more comfortable as a beginner. At the same time, for the advanced lifters, it assists them in finding other experienced lifters with similar training styles. The possibilities for applications of this feature are endless.</p>
                    <BorderPic imgPath="FitBud4.png" picDesc="Discover Friends Screen" />
                    <p className="general-font">Exercise tracking is an extremely important element to success at the gym. Through tracking one's reps, sets, and weight, users can easily view their progression and take proper measures to overcome future plateaus. Our app provides users with the ability to create their own workout routine or use premade training templates.</p>
                    ...
                    <p className="general-font">This app was developed with React and Node (Express). View the full project on <a href="https://github.com/patrick-du/FitBud" target="_blank" className="hvr-underline-from-left purple">Github</a>.</p>
                    <hr />
                </Fade>
