...
const FitBud = () => {
    ...
    return (
        <div className="container-fluid container-padding">
            <PostTop subtitle="uOttaHack 2019" title="Fitbud" cancel="/projects" next="/projects/fgfbrands" />
            ...
            <p className="s-font">Features include:</p>
            <p className="s-font my-0">- Friend Finder: lift together with members of similar training styles or simply make a new friend</p>
            <p className="s-font my-0">- Exercise Tracker: create workout routines and easily log exercises, sets, and reps </p>
            <p className="s-font my-0">- Music Player: access all your Spotify music within this app </p>
