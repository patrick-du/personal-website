  ...
  render() {
    return (
      <div className="container-fluid mx-auto px-0">
        <img
          src={require(`../../assets/serenityA-opt.png`)}
        ...
        <div className="projectContainer mx-auto px-0">
          <Fade big>
            ...
            <p className="general-font">
              ...
              Patient Health Questionnaire (PHQ-9) and General Anxiety Disorder
              7 (GAD-7) for mental health disorders. These are used by health
              care professionals to objectively determine the severity of
            ...
            <p className="general-font">
              ...
              such as reps, sets, and weight, Serenity aims to make users aware
              of the correlation between even modest amounts of exercise and
              mental health improvements. In doing so, users will be more likely
              to utilize physical activity as an intervention when experiencing
