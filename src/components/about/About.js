    ...
    render() {
        ...
        return (
            <div className="container-fluid projectContainer mx-auto px-0">
                ...
                <Fade big>
                    <p className="s-font mt-3">I'm a 2nd year student at the University of Waterloo studying Kinesiology. Currently, I am located in Waterloo, Ontario for my 2B academic term. Previously, I interned as a <Link to="/work" className="hvr-underline-from-left purple"> web developer at FGF Brands</Link>. In my free time, you can find me lifting weights, playing sports, browsing Reddit, and discovering new music on <a className="hvr-underline-from-left-spotify green" href="https://open.spotify.com/user/pdupapaya" target="_blank">Spotify</a>.</p>
                    <hr />
                    <p className="s-font">I am a very goal-oriented individual and constantly aim for new heights, whether it be in my academic development, or simply setting new PRs at the gym. For the 2019 summer term, I have three main goals I hope to achieve and I am excited to see where my strong work ethic and perseverance will take me.<br /><br />
                        Academic Goal: Become proficient in a back-end language (Java)<br /><br />
