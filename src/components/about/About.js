    ...
    render() {
        ...
        return (
            <div className="container-fluid projectContainer mx-auto px-0">
                ...
                <Fade big>
                    <p className="s-font mt-3">I'm a 3rd year student at the University of Waterloo studying Kinesiology with a minor in Computing. Currently, I am interning as a <Link to="/work" className="hvr-underline-from-left purple"> software developer at Oculys Health Informatics</Link> in Waterloo, Ontario for my 2nd coop term. In my free time, you can find me lifting weights, playing sports, browsing Reddit, and discovering new music on <a className="hvr-underline-from-left-spotify green" href="https://open.spotify.com/user/pdupapaya" target="_blank">Spotify</a>.</p>
                    <hr />
                    <p className="s-font">I am a very goal-oriented individual and constantly aim for new heights, whether it be in my academic development, or simply setting new PRs at the gym. For the 2019 fall term, I have three main goals I hope to achieve and I am excited to see where my strong work ethic and perseverance will take me.<br /><br />
