        ...
        <div className="container-fluid main-px mt-5">
            <div className="row">
                <div className="col-9">
                    ...
                    <p className="s-font reg">I'm a 2nd year student currently working at FGF Brands as a front-end developer. <br /> I attend the <span className="med">University of Waterloo</span> for Kinesiology. <br />In my free time, I play sports, work out, browse reddit, and drink bubble tea. </p>
                </div>
                <div className="col-3">
            ...
            <div className="aboutBox my-5 p-3 ">
                ...
                <hr />
                <p className="s-font-reg">For the future, I plan to complete my kinesiology degree with a health informatics option expanding my understanding of the field that investigates how computer technologies can be utilized to better generate, manage, store, and apply health information.  </p>
                <h5 className="s-font lead text-center">My work strives to explore the intersection of technology with fitness and health.</h5>
                <p className="s-font-reg">By studying Kinesiology I will acquire a profound understanding of physiological, biomechanical, and psychological dynamic principles and mechanisms of movement allowing me to innovate technology for the fitness and health industry in ways that a computer science or engineering graduate cannot.</p>
                <blockquote className="blockquote">
                    ...
                    <footer className="blockquote-footer">Steve Jobs in <cite title="Source Title">Source Title</cite></footer>
                </blockquote>
