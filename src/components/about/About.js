        ...
        return (
            ...
            <hr/>
                ...
                <Link to="/about/story" className="linkdec">
                        <div className="s-font med" style={{ fontWeight: '600', fontSize: '18px' }}>How I Started Coding
                ...
                <Link to="/about/career" className="linkdec">
                        <div className="s-font med" style={{ fontWeight: '600', fontSize: '18px' }}>Plans for the Future
                            <i class="fas fa-arrow-right" style={{ fontSize: '18px', float: "right" }} />
