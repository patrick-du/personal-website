    ...
    return (
        <div className="container-fluid main-px py-5">
            <div className="aboutBox p-5">
                ...
                <PicHolder imgPath="story.PNG" caption="Patrick's UWaterloo Survival Guide for Kinesiology: Study, Gym, Protein, REPEAT"/>
                <p className="s-font">This was no different in the summer except there was no studying. I dedicated that chunk of time for studying to playing video games and rewatching every single Marvel movie leading up to Avengers: Infinity War (all 18 of them). I highly recommend - the interconnectivity of each film is unique and the way Marvel sows together fuses each film with their own distinct storylines and purposes is absolutely incredible.</p>
                <PicHolder imgPath="story1.PNG" caption="The Greatest Movie Franchise: Marvel Cinematic Universe"/>
                <p className="s-font">Remember how I said my friends were always working on side projects? In the same span of time, my roommate had just completed 2 coding courses, developed a mini game, made his resume, and was in the process of creating his second website. All I'd done was watch movies, work out, and bought some new clothes...the least I could do was make my resume.  </p>
               
                <PicHolder imgPath="story2.png" caption="My Roommate's Github Contributions 🤯"/>
                <p className="s-font">When I checked out his portfolio it inspired me to create my own website, so based on his recommendation I took a beginner HTML5 and CSS3! At the end of the summer, I launched my first website.</p>
                <p className="s-font">Following this project, my interest in coding had been sparked  and with coop applications coming up I decided to take a stab at applying for a position I was in no way qualified for. With a combination of hard-work and coffee I was able to land an interview and secure a web developer 👨‍💻 position at FGF Brands for my first coop term. Since then, I have attended several hackathons and expanded my skill set immensely.</p>
            </div>
        </div>
