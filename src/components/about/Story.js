            ...
            <div className="aboutBox p-5">
                <div className="row">
                    ...
                    <div className="col-10 text-center">
                        <p className="s-font med no-y-space lightText">My Story</p>
                        <h1 className="p-font bold">How I started Coding</h1>
                    </div>
                    <div className="col-1">
                ...
                <PicHolder imgPath="story1.PNG" caption="My School Survival Guide to Kinesiology: Study, Gym, Protein, REPEAT" />
                ...
                <p className="s-font">When I checked out his portfolio it inspired me to create my own website, so based on his recommendation I took a beginner HTML5 and CSS3 course. By the end of the summer, I launched my <a className="hlink" href="https://patrickdu.herokuapp.com" target="_blank">first website</a>!</p>
                <PicHolder imgPath="story3.PNG" caption="My First Website" />

                <p className="s-font">Following this project, my passion for coding continued to sprout and with coop applications coming up I decided to take a stab at applying for a position I was in no way qualified for. With a combination of hard-work and lots of Tim Horton's coffee ☕ I was able to land an interview and secure a web developer position at <Link to="../../work" className="hlink">FGF Brands</Link> for my first coop term. Since then, I have attended several hackathons and expanded my skill set immensely.</p>
